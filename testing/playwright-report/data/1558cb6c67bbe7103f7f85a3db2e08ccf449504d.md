...
- Name: visitor-registration.spec.ts >> Visitor Registration >> [R1_VR_TC_001] should submit visitor registration form successfully with valid data
- Location: tests/visitor-registration.spec.ts:44:7
...
- button "Resend OTP after (59s)" [disabled]
- text: OTP
- textbox "OTP": "123456"
- button "Verify OTP"
- text: Mobile Number
...
- alert:
  - img "check-circle"
  - text: OTP Sent OTP has been sent to the email address
  - button "Close":
    - img "Close"
- alert:
  - img "close-circle"
  - text: Invalid OTP OTP is invalid. Please check the OTP and try again
  - button "Close":
    - img "Close"
```
