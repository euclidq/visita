...
- Name: visitor-registration.spec.ts >> Visitor Registration >> [R1_VR_TC_014] should show error message with empty unit number
- Location: tests/visitor-registration.spec.ts:141:7
...
Locator: getByText('OTP Verified')
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible"
  - waiting for getByText('OTP Verified')
...
- text: First Name
- textbox "First Name": Euclid
- text: Last Name
- textbox "Last Name": Quemada
- text: Email Address
