...
- Name: visitor-registration.spec.ts >> Visitor Registration >> [R1_VR_TC_012] should show error message with empty purpose
- Location: tests/visitor-registration.spec.ts:123:7
